...
sl_entete('Accueil', './styles/eResto.css');
// génération du menu (connecté ou pas)
sl_menu('Accueil', '.', isset($_SESSION['user']) ? $_SESSION['user']['login'] : false);
...
function sll_contenu()
{
    ...
    '<p class="notice">Le restaurant universitaire ouvrira à partir du 10 août 2021. Aucun repas ne sera servi avant cette date. Pour faire face à la situation sanitaire, le restaurant sera en place au moins jusqu\'au 9 août 2023. Nous sommes fermés le samedi et le dimanche.</p>',
    '<section>',
